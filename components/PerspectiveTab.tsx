...
5.  **Chất lượng cuối cùng**: Hình ảnh phải sắc nét, có chiều sâu, và đạt chất lượng của một bức ảnh quảng cáo thời trang chuyên nghiệp.`;
            ...
            // FIX: Upgraded model to gemini-3-pro-image-preview to support 4K image generation as requested in the prompt.
            const images = await generateImage('gemini-3-pro-image-preview', parts, aspectRatio);
            ...
            setResultImages(images);
             ...
             if (e instanceof Error) {
                if (e.message.includes('API key not valid') || e.message.includes('Requested entity was not found')) {
                    setError("Lỗi Khóa API. Vui lòng đảm bảo khóa của bạn hợp lệ và đã được định cấu hình.");
                } else {
                    setError(e.message);
                }
            } else {
    ...
    return (
        <div className="space-y-6">
            ...
            <button
                ...
                disabled={loading || !outfitFile || !description}
